...
static const u1_t PROGMEM DEVEUI[8]={ 0xF6, 0xE4, 0x70, 0x5D, 0xDE, 0xD4, 0x52, 0x00 };
...
static const u1_t PROGMEM APPKEY[16] = { 0x00, 0xCE, 0x07, 0xB7, 0x71, 0x93, 0x76, 0x0C, 0x38, 0x04, 0x1D, 0x5D, 0xB6, 0xC2, 0x3B, 0x3D };
